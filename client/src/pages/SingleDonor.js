...
import SingleDonorImg from "../assets/addDonor.png";
...
const SingleDonor = ({_id}) => {
  ...
  return (
    <div>
      <div className="image">
        <img src={SingleDonorImg} alt="DonorImg" style={{width:"1525px", opacity:"0.6", position:"absolute", top:"0",bottom:"0",left:"0",right:"0"}}/>
    </div>
