...
import SingleDonationImg from "../assets/donation.jpg";
...
const SingleDonation = ({_id}) => {
  ...
  return (
    <div>
      <div className="image">
        <img src={SingleDonationImg} alt="Donation" style={{width:"1525px", opacity:"0.7", position:"absolute", top:"0",bottom:"0",left:"0",right:"0"}}/>
      </div>
      <div
        style={{
          marginTop: "80px",
