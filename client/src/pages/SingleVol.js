...
import SingleVolImg from "../assets/volunteer.jpg";
...
const SingleVol = ({_id}) => {
  ...
  return (
    <div>
      <div className="image">
        <img src={SingleVolImg} alt="volunteer" style={{width:"1525px", opacity:"0.6", position:"absolute", top:"0",bottom:"0",left:"0",right:"0"}}/>
      </div>
      <div
        style={{
          marginTop: "80px",
