...
import EditImg from "../assets/addDonor.png";
...
const EditDonor = () => {
  ...
  return (
    <div className="col-12 col-md-12 col-sm-12 col-12" style={{marginTop:"100px"}}>
            <div className="image">
                <img src={EditImg} alt="EditDonorImage" style={{width:"1525px", opacity:"0.6", position:"absolute", top:"0",bottom:"0",left:"0",right:"0"}}/>
            </div>
